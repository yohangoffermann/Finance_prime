...
with st.sidebar:
    ...
    valor_credito = st.text_input("Valor do Crédito", value="R$ 1.000.000,00", key="valor_credito")
    ...
    valor_lance = st.text_input("Valor do Lance", value="R$ 200.000,00", key="valor_lance")
...
with col1:
    valor_dropdown = st.text_input("Valor do Dropdown", value="R$ 100.000,00", key="valor_dropdown")
