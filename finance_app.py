...
def format_monetary_input(value):
    try:
        numeric_value = parse_currency(value)
...
with st.sidebar:
    ...
    valor_credito = format_monetary_input(valor_credito)
...
with col1:
    ...
    valor_dropdown = format_monetary_input(valor_dropdown)
with col2:
...
st.sidebar.info("Constructa MVP - Versão 1.1.2")
